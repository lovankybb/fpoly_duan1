...
<main class="admin-main-content">
    <header class="page-header">
        <h1>Cập nhật biến thể mới [${product.name}]</h1>
    ...
    <div class="form-card">
        ...
        <form action="${pageContext.request.contextPath}/admin/variant/update" method="post">
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="versionId" required>
                        ...
                        <c:forEach var="version" items="${versions}">
                            <option ${variant.version.id == version.id ? 'selected' : ''} value="${version.id}">${version.name}</option>
                        </c:forEach>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select name="colorId" required>
                        ...
                        <c:forEach var="color" items="${colors}">
                            <option ${variant.color.id == color.id ? 'selected' : ''} value="${color.id}" style="color: ${color.hex}; font-weight: bold;">
                                ■ ${color.name}
                            </option>
                        </c:forEach>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input value="<fmt:formatNumber value='${variant.price}' groupingUsed='false' maxFractionDigits='0'/>" type="number" name="price" placeholder="VD: 1400000" min="0"
                           >
                    <span class="error">${priceError}</span>
                </div>
                <div class="form-group">
                    <label>Số lượng</label>
                    <input value="${variant.stock}" type="number" name="stock" placeholder="VD: 10" min="0" >
